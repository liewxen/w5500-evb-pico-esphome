...
CONFLICTS_WITH = ["w5500_ethernet"]
DEPENDENCIES = ["rp2040"]
AUTO_LOAD = ["network", "ethernet"]

w55rp20_ns = cg.esphome_ns.namespace("w55rp20_ethernet")
...
W55RP20EthernetComponent = w55rp20_ns.class_(
    "W55RP20EthernetComponent", EthernetBaseComponent
)
ManualIP = w55rp20_ns.struct("ManualIP")
...
async def to_code(config):
    ...
    # Inject use_address into ethernet stub for ESPHome core
    ...
    cg.add_define("USE_W55RP20_ETHERNET")
